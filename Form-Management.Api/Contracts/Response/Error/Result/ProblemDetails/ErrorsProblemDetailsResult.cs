...
public static class ErrorsProblemDetailsResult
{
    ...
    private static ProblemDetailsResponseObject<ErrorResponseObject<TErrorObject>> CreateErrorProblemDetails
        <TErrorObject>(this TErrorObject error, HttpContext context, string title, int status, string detail)
    {
