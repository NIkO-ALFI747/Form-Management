...
const Toolbar: FC<ToolbarProps> = ({ isLoading, setUsers, selectedCount, setSelectedCount, loadUsers }) => {
  ...
  return (
    <div className="d-flex justify-content-between align-items-center mb-1">
      ...
      <DeleteButton selectedCount={selectedCount} setSelectedCount={setSelectedCount}
        isDeleting={isDeleting} setDeleting={setDeleting} isLoading={isLoading} setUsers={setUsers}
      />
    </div>
  )
}
